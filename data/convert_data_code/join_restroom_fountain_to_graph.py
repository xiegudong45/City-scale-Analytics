...
def main():
    ...
    fountain_file = "../external_data/Drinking Fountain.geojson"
    restroom_file = "../external_data/Public Restroom.geojson"
    dog_off_leash_file = "../external_data/Dog Off Leash Areas.geojson"
    hospital_file = "../external_data/Hospitals.geojson"
    sidewalks_file = "../raw_data/sidewalk_new.geojson"

    df_fountain = gpd.read_file(fountain_file)
    df_restroom = gpd.read_file(restroom_file)
    df_dol = gpd.read_file(dog_off_leash_file)
    df_hos = gpd.read_file(hospital_file)
    ...
    dol_sidewalk_id, dol_project_pt, dol_array = processing(df_dol, df_sw)

    hos_sidewalk_id, hos_project_pt, hos_array = processing(df_hos, df_sw)
    ...
    df_sw['hospital'] = hos_array
    df_sw['dog_off_leash_areas'] = dol_array
